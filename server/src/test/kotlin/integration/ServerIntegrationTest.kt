...
class ServerIntegrationTest {
    ...
    fun canGetAPngCourseIcon() {
        ...
        val jsonNode = responseJson[0]
        assertThat(jsonNode["name"].toString().unquoted(), equalTo("pngtest"))
        assertThat(jsonNode["imageType"].toString().unquoted(), equalTo("png"))
    ...
    fun canGetAJpgCourseIcon() {
        ...
        val jsonNode = responseJson[0]
        assertThat(jsonNode["name"].toString().unquoted(), equalTo("jpgtest"))
        assertThat(jsonNode["imageType"].toString().unquoted(), equalTo("jpg"))
